 ...
 * `next`-endpoint fetches, [ChunkedDataSource][com.music.yzmusic.playback.ChunkedDataSource]
 * and [AudioCache][com.music.yzmusic.playback.AudioCache]'s multi-megabyte
