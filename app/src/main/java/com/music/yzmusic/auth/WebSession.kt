 ...
 * signing out of YZ Music forgets the cookie the app makes requests with, and
...
object BrowserSession {
    ...
    fun clearGoogleCookies() {
        ...
        val manager = runCatching { CookieManager.getInstance() }.getOrElse {
            Log.w("YZ Music", "no cookie manager to clear: ${it.message}")
            return
        }
        var cleared = 0
        ...
        Log.d("YZ Music", "cleared $cleared browser cookies for Google")
    }
