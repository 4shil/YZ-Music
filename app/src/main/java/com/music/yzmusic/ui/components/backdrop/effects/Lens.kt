 ...
 */
package com.music.yzmusic.ui.components.backdrop.effects
...
import com.music.yzmusic.ui.components.backdrop.BackdropEffectScope
import com.music.yzmusic.ui.components.backdrop.internal.RoundedRectRefractionShaderString
import com.music.yzmusic.ui.components.backdrop.internal.RoundedRectRefractionWithDispersionShaderString
import com.music.yzmusic.ui.components.backdrop.internal.RuntimeShaderEffect
import com.music.yzmusic.ui.components.backdrop.isRuntimeShaderSupported
...
fun BackdropEffectScope.lens(
    ...
    if (!currentSize.isSpecified || currentSize.width <= 0f || currentSize.height <= 0f || currentSize.width.isNaN() || currentSize.height.isNaN()) return
