 ...
 */
package com.music.yzmusic.ui.components.backdrop.backdrops
...
import com.music.yzmusic.ui.components.backdrop.Backdrop
import com.music.yzmusic.ui.components.backdrop.internal.InverseLayerScope
        ...
        withTransform({
            ...
            val offset =
                try {
                    ...
                    if (coordinates.isAttached && layerCoordinates.isAttached) {
                        try {
