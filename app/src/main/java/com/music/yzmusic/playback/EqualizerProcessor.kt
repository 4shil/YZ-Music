...
/**
 * 10-slot state-variable parametric equaliser and balance trim.
 *
 * Sits in the silence-skipping renderers factory's processor chain between
 * [SpatialAudioProcessor] and [TransitionFilterProcessor], taking 16-bit PCM and
...
class EqualizerProcessor : BaseAudioProcessor() {
    ...
    companion object {
        private const val TAG = "YZMusicEqualizer"
